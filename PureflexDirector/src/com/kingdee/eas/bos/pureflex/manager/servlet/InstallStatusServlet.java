...
public class InstallStatusServlet extends HttpServlet{
	Logger logger = Logger.getLogger(InstallStatusServlet.class);
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		    ...
		    try {
		        result.put("alreadyInstalled", AppContext.get(AppContext.ALREADY_INSTALLED,"false"));
