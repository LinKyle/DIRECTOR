...
public class ConcurrentInfoServlet extends HttpServlet{
	Logger logger = Logger.getLogger(ConcurrentInfoServlet.class);
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		    ...
		    try {
		        result.put("concurrentNum", AppContext.get(AppContext.CONCURRENT_NUM));
